...
--   Oracle-generated current time uses LOCALTIMESTAMP.
-- ============================================================================
...
(CUST_ID, MOBILE_NUMBER, PASSKEY_HASH,
 COOLING_START_TIME, COOLING_END_TIME, UPDATED_TIME)
VALUES (?, ?, ?, NULL, NULL, LOCALTIMESTAMP);
...
SELECT ?, ?, ?, CURRENT_TS, CURRENT_TS + NUMTODSINTERVAL(48, 'HOUR')
FROM (
...
SELECT CUST_ID,
       ...
       COOLING_END_TIME,
       CASE
           WHEN LOCALTIMESTAMP < COOLING_END_TIME
               THEN 'ACTIVE'
           ELSE 'COMPLETED'
